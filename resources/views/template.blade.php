...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
        <div class="container">
            ...
            <!-- Image Logo -->
             <a class="navbar-brand logo-image" href="#home"><img src="./assets/images/favicon.jfif" alt="alternative"></a>

            <!-- Text Logo - Use this if you don't have a graphic logo -->
            <a class="navbar-brand logo-text" href="#home">Asips</a>
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault" >
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#about stunting">About Stunting</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="about d-flex align-items-center text-light py-5" id="about us">
        <div class="container" >
    ...
    <!-- about stunting -->
    <section class="services d-flex align-items-center py-5" id="about stunting">
        <div class="container text-light">
            <div class="text-center pb-4" >
                <p></p>
                <h2 class="py-2">ABOUT STUNTING</h2>
                <p class="para-light">Stunting adalah masalah kurang gizi kronis yang disebabkan oleh kurangnya asupan gizi dalam waktu yang cukup lama, sehingga mengakibatkan gangguan pertumbuhan pada anak yakni tinggi badan anak lebih rendah atau pendek (kerdil) dari standar usianya.</p>
            </div>
            <div class="row gy-4 py-2" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-hospital fa-2x"></i>
                        <h4 class="py-2">Kadar Gizi Buruk Sejak Masa Kehamilan</h4>
                        <p class="para-light">embrio yang sedang berkembang bergantung pada makanan yang dikonsumsi oleh ibu, nutrisi yang buruk bisa membatasi pertumbuhan janin</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-hospital fa-2x"></i>
                        <h4 class="py-2">Lingkungan Tidak Mendukung</h4>
                        <p class="para-light">Kelalaian atau ketidakhadiran pengasuh dapat menyebabkan kebutuhan makan anak tidak maksimal  dan juga seharusnya mendapatkan sumber hewani seperti produk susu, telur dan daging.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-hospital fa-2x"></i>
                        <h4 class="py-2">Kurangnya Makanan Pendamping ASI(MPASI)</h4>
                        <p class="para-light">Mulai usia 6 bulan, kebutuhan anak akan energi dan nutrisi tidak cukup disokong dari asupan ASI saja, kombinasikan makanan seperti sereal dan makanan pokok lainnya, buah-buahan dan sayuran halus, susu dan telur, serta ikan dan daging.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-hospital fa-2x"></i>
                        <h4 class="py-2">Masalah Kebersihan</h4>
                        <p class="para-light">Penyebab stunting pada anak selanjutnya datang dari masalah kebersihan makanan dan air yang tidak terjamin.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-hospital fa-2x"></i>
                        <h4 class="py-2">Kurang mendapat ASI</h4>
                        <p class="para-light">World Health Organization (WHO) merekomendasikan bahwa ibu mulai menyusui dalam waktu satu jam setelah kelahiran hingga usia 6 bulan.</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        <i class="fas fa-hospital fa-2x"></i>
                        <h4 class="py-2">Infeksi</h4>
                        <p class="para-light">Penyebab stunting pada anak bisa saja karena terserang infeksi. Penyakit diare dan penyakit pernapasan diketahui berdampak buruk pada pertumbuhan anak.</p>
                    </div>
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    {{-- <section class="services d-flex align-items-center py-5" id="about stunting">
        <div class="container text-light">
            <div class="text-center pb-4" >
                <h2 class="py-2">About Stunting</h2>
                <p class="para-light">Stunting adalah masalah kurang gizi kronis yang disebabkan oleh kurangnya asupan gizi dalam waktu yang cukup lama, sehingga mengakibatkan gangguan pertumbuhan pada anak yakni tinggi badan anak lebih rendah atau pendek (kerdil) dari standar usianya.</p>
                <h2 class="py-2">Penyebab Stunting</h2>
            </div>
            <div class="row gy-4 py-2" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card bg-transparent">
        ...
        <div class="container" data-aos="zoom-in">
            <div class="row">
                ...
                <div class="col-lg-3 d-flex align-items-center" >
                    ...
                    <div class="ms-2">
                        <h6>kirim Pesan Pada Kami</h6>
                        <p>hasbizulfan@gmail.com</p>
                    </div>
                </div>
                <div class="col-lg-3 d-flex align-items-center" >
                    <div class="p-2"><i class="far fa-clock fa-3x"></i></div>
                    <div class="ms-2">
                        <h6>Jadwal Pelayanan</h6>
                ...
                <div class="col-lg-3 py-4 py-md-5">
                    <div>
                        ...
                        <div class="d-flex align-items-center py-2">
                            ...
                            <a href="#home"><p class="ms-3">Home</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="#about us"><p class="ms-3">About Us</p></a>
                        </div>
                        <div class="d-flex align-items-center py-2">
                            <i class="fas fa-caret-right"></i>
                            <a href="#about stunting"><p class="ms-3">About Stunting</p></a>
                        </div>
                    </div>
                </div> <!-- end of col -->
